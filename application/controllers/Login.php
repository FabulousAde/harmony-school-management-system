...
class Login extends CI_Controller {
    ...
    public function register($type = '') {
        ...
        if($type == 'instructor') {
            $data['class_options']  = html_escape($this->input->post('class_options'));
        ...
        if ($validity) {
            // if (empty($data['class_options']) || $data['class_options'] == 'select_class') {
            //     $this->session->set_flashdata('flash_message', get_phrase('no_class_selected'));
            // }else{
