...
<section class="menu-area">
    <div class="container-xl complete_padding">
        <div class="row">
            <div class="col">
                <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#"><img src="<?php echo base_url().'uploads/system/logo-dark.png'; ?>" alt="" height="35"></a>
                    <a href="https://localhost/hbs">
                        <div class="navbar-brand-text">
                          HBS
                        </div>
                    </a>
                <nav class="navbar navbar-expand-lg navbar-light bg-white navbar-right header_links">
                    ...
                    <a class="cat" href="<?= site_url(''); ?>"><?= get_phrase('home'); ?></a>
                    ...
                    <div class="cat">
                      <a href="#">Teach on HBS</a>
                      <a href="#"><?=get_phrase('about_us');?></a>
                    </div>

                    <?php 
                    $usern_details = $this->user_model->get_user($this->session->userdata('user_id'))->row_array();
                    if ($usern_details['is_instructor'] == '1' && get_settings('allow_instructor') == 1): ?>
                    ...
                    <div class="instructor-box menu-icon-box">
                        <div class="icon">
                            <a href="<?php echo site_url('home/my_courses'); ?>" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0; min-width: 100px;"><?php echo get_phrase('my_dashboard'); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="user-box menu-icon-box">
                        ...
                        <div class="dropdown user-dropdown corner-triangle top-right">
                            <ul class="user-dropdown-menu">
                                ...
                                <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/study_history'); ?>"><i class="fas fa-book-open"></i><?php echo get_phrase('study_history'); ?></a></li>
                                ...
                                <li class="user-dropdown-menu-item"><a href="<?php echo site_url('home/my_results'); ?>"><i class="fas fa-poll-h"></i><?php echo get_phrase('my_certificates'); ?></a></li>
                                <!-- <li class="user-dropdown-menu-item"><a href="<?php // echo site_url('home/activiities'); ?>"><i class="fas fa-chart-line"></i><?php echo get_phrase('activiities'); ?></a></li> -->
