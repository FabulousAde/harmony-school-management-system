<div class="row">
    <div class="col-lg-12">
        <div class="card text-white text-center bg-quiz-result-info mb-3">
            <div class="card-body">
                <h5 class="card-title">E-learning answers.</h5>
                <h6 style="font-weight: 800;"><?php echo $quiz_info['title']; ?></h6>
...
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card text-left card-with-no-color-no-border transp">
            <div class="card-body">
