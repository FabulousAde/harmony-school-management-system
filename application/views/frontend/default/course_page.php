            ...
            <div class="lecture-group-wrapper">
              ...
              <div id="collapse<?php echo $section['id']; ?>" class="lecture-list collapse <?php if($counter == 0) echo 'show'; ?>">
                <ul>
                  ...
                  <?php if($this->session->userdata('user_login')): ?><a href="<?php echo base_url("home/lesson/".slugify($lesson['title'])."/".$lesson['course_id']); ?>">
              ...
              <div class="item-details float-left">
                ...
                <?php if ($other_realted_course['is_free_course'] == 1): ?>
                  <span class="item-price">
                    <span class="current-price"><?php echo get_phrase('course'); ?></span>
                  </span>
                <?php else: ?>
    ...
    <div class="course-sidebar-text-box">
      <div class="price">
        <?php if ($course_details['is_free_course'] == 1): ?>
          <span class = "current-price"><span class="current-price"><?php echo get_phrase('course'); ?></span></span>
        <?php else: ?>
        ...
        <?php if ($course_details['is_free_course'] == 1): ?>
          <div class="buy-btns">
            <?php if ($this->session->userdata('user_login') != 1): ?>
              <a href = "#" class="btn btn-buy-now" onclick="handleEnrolledButton()"><?php echo get_phrase('enroll_now'); ?></a>
            <?php else: ?>
              <a href = "<?php echo site_url('home/get_enrolled_to_free_course/'.$course_details['id']); ?>" class="btn btn-buy-now"><?php echo get_phrase('enroll_now'); ?></a>
            <?php endif; ?>
          </div>
        <?php else: ?>
          <div class="buy-btns">
