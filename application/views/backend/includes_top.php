...
<link href="<?php echo base_url('assets/backend/css/vendor/datetime_picker.css'); ?>" rel="stylesheet" type="text/css" />
...
<script src="<?php echo site_url('assets/backend/js/datetime_picker.js');?>"></script>
