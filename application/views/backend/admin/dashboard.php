<?php
    ...
    $number_of_students = $this->user_model->get_only_user()->num_rows();
    $number_of_instructors = $this->user_model->get_insructors_list()->num_rows();
?>
<div class="row">
    <div class="col-xl-12">
        <div class="card">
        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-6 col-xl-2">
                        <a href="<?php echo site_url('admin/instructors'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <i class="dripicons-user-group text-muted" style="font-size: 24px;"></i>
                                    <h3><span><?php echo $number_of_instructors; ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('number_of_instructors'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
