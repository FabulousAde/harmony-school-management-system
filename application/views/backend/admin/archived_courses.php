                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                              ...
                                              <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/course_actions/unarchive/'.$course['id']); ?>');"><?php echo get_phrase('unarchive_course'); ?></a></li>
                                          </ul>
                                      </div>
                                    </td>
                                </tr>
