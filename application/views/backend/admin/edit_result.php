...
<form action="<?php echo site_url('/admin/result/update/'.$all_result_log['id'].'/'.$all_result_log['sid']); ?>" method="POST">
        ...
        <div class="alert alert-warning" role="alert">
    		...
    		<div class="form-group">
                ...
                <div class="mt-2">
                    ...
                    <input type="text" name="grand_total" value="<?php echo $all_result_log['grand_total']; ?>" class="form-control" placeholder="100/100">
                </div>
                <div class="mt-2">
                    <label for="average"><?php echo get_phrase('average %'); ?></label>
                    <input type="text" name="average" value="<?php echo $all_result_log['average']; ?>" class="form-control" placeholder="%">
                </div>
                <div class="session mt-2">
