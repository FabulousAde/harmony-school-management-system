                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control select2" data-toggle="select2" name="level" id="level">
                                                        <option value="executive_training_course" <?php if($course_details['level'] == "executive_training_course") echo 'selected'; ?>><?php echo get_phrase('executive_training_course'); ?></option>
                                                        <option value="regular_training" <?php if($course_details['level'] == "regular_training") echo 'selected'; ?>><?php echo get_phrase('regular_training'); ?></option>
                                                        <option value="professional_courses" <?php if($course_details['level'] == "professional_courses") echo 'selected'; ?>><?php echo get_phrase('professional_courses'); ?></option>
                                                        <option value="professional_diplomas" <?php if($course_details['level'] == "professional_diplomas") echo 'selected'; ?>><?php echo get_phrase('professional_diplomas'); ?></option>
                                                        <option value="vocational_courses" <?php if($course_details['level'] == "vocational_courses") echo 'selected'; ?>><?php echo get_phrase('vocational_courses'); ?></option>
                                                </select>
                                            </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="language_made_in" id="language_made_in">
                                                         <option value="english"><?php echo ucfirst("english"); ?></option>
                        ...
                        <div class="tab-pane" id="media">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-xl-8">
                                 ...
                                 <div class="col-xl-8">
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="course_overview_provider"><?php echo get_phrase('search_resources'); ?></label>
                                            <div class="col-md-10">
                                      ...
                                      <?php foreach ($resources as $courseresources): ?>
                                              <option value="<?php echo $courseresources['stored_location']; ?>"><?php echo $courseresources['file_name']; ?></option>
                                      <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
