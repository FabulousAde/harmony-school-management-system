<div class="row">
	<div class="col-xl-12">
		<div class="card">
			 <div class="card-body">
	                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('add_activity_resources'); ?></h4>
	        </div>
		</div>
	</div>
</div>
		...
		<div class="">
			<div class="card widget-inline">
				<div class="card-body p-4">
				    <h4 class="mb-3 header-title">ADD RESOURCES</h4>
					<!--<h6>-->
					...
					<!--</h4>-->
					<form action="<?php echo base_url('admin/upload_activity_resources'); ?>" method="post" enctype="multipart/form-data">
						...
						<div id="input_name_div" class="hidden">
							<label for="select_resource">
								<?php echo get_phrase('stored_resource_name'); ?>
		    				    <span class="required">*</span>
						    </label>
							<div class="form-group mb-2">
						...
						<div class="row justify-content-center">
						    <div class="col-md-5"><button type="submit" class="btn btn-block btn-primary"><?php echo get_phrase('upload_resource');  ?></button></div>
						</div>
					</form>
				</div>
			</div>
...
<script>
	$(document).ready(function () {
		$('#resource_file_selection').on('change', function (e) {
			...
			$('.file_details').empty();
			$('.saved_name').empty();
			var custom_location = "<?php echo base_url()."uploads/core/video/"; ?>";
