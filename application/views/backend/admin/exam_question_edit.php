<?php
    ...
    $question_details = $this->crud_model->get_exam_question_by_id($param2)->row_array();
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('admin/exam_questions/'.$param3.'/edit/'.$param2); ?>',
        type: 'post',
    ...
    showLargeModal('<?php echo site_url('modal/popup/exam_questions/'.$param3); ?>', '<?php echo get_phrase('manage_exam_questions'); ?>');
});
</script>
