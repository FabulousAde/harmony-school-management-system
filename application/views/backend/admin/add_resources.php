<div class="row">
	<div class="col-xl-12">
		<div class="card">
			 <div class="card-body">
	                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('add_resources'); ?></h4>
	        </div>
		</div>
	</div>
</div>
		...
		<div class="">
			<div class="card widget-inline">
				<div class="card-body">
					...
					<!--</h4>-->
					<form action="<?php echo base_url('admin/upload_course_resources'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row justify-content-center">
						    <div class="col-md-4"><button type="submit" class="btn btn-block btn-primary"><?php echo get_phrase('upload_resource');  ?></button></div>
						</div>
					</form>
				</div>
			</div>
