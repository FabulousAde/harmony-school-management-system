<form action="<?php echo site_url('admin/exam_questions/'.$param2.'/add'); ?>" method="post" id = 'mcq_form'>
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('admin/exam_questions/'.$param2.'/add'); ?>',
        type: 'post',
    ...
    showLargeModal('<?php echo site_url('modal/popup/exam_questions/'.$param2); ?>', '<?php echo get_phrase('manage_exam_questions'); ?>');
});
</script>
