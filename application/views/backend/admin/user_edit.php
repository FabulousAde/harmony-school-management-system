                ...
                <form class="required-form" action="<?php echo site_url('admin/users/edit/'.$user_id); ?>" enctype="multipart/form-data" method="post">
                    <div id="progressbarwizard">
                        <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                            ...
                            <li class="nav-item">
                                <a href="#academic_info" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                    <i class="fas fa-graduation-cap"></i>
                                    <span class="d-none d-sm-inline"><?php echo get_phrase('academic_info'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#user_info" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                    <i class="mdi mdi-wifi mr-1"></i>
                                    <span class="d-none d-sm-inline"><?php echo get_phrase('user_info'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content b-0 mb-0">
                            ...
                            <div class="tab-pane" id="academic_info">
                                <div class="row">
                                    <div class="col-12">
                                         <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="student_category"><?php echo get_phrase('student_category'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <select name="category" id="category" class="form-control">
                                                    <option value="<?php echo $user_data['category']; ?>">
                                                        <?php echo get_phrase($user_data['category']); ?>
                                                    </option>
                                                </select>
                                            </div>
                                          </div>
                                          <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="student_class"><?php echo get_phrase('student_class'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <select name="class_option" id="class_option" class="form-control">
                                                    <option value="<?php echo $user_data['class_options']; ?>">
                                                        <?php echo get_phrase($user_data['class_options']); ?>
                                                    </option>
                                                </select>
                                            </div>
                                          </div>
                                          <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <select name="userstsatstus" id="userstsatstus" class="form-control">
                                                    <?php if($user_data['status'] == 1): ?>
                                                    <option value="<?php echo $user_data['status']; ?>">
                                                        <?php echo get_phrase("enabled"); ?>
                                                    </option>
                                                    <option value="0">
                            ...
                            <div class="tab-pane" id="user_info">
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="lga"><?php echo get_phrase('lga'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="lga" name="lga" value="<?php echo get_phrase($user_data['lga']); ?>" class="form-control" placeholder="LGA">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="state"><?php echo get_phrase('state_of_origin'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="state" id="state" value="<?php echo get_phrase($user_data['state']); ?>" class="form-control" placeholder="State of Origin">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="nationality"><?php echo get_phrase('nationality'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="nationality" id="nationality" value="<?php echo get_phrase($user_data['nationality']); ?>" class="form-control" placeholder="Nationality">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="address"><?php echo get_phrase('residential_address'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="address" value="<?php echo get_phrase($user_data['address']); ?>" name="address" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="phone"><?php echo get_phrase('phone_number'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="phone" id="phone" value="<?php echo get_phrase($user_data['phone']); ?>" name="phone" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="genotype"><?php echo get_phrase('genotype'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="genotype" maxlength="10" value="<?php echo get_phrase($user_data['genotype']); ?>" name="genotype" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="blood_group"><?php echo get_phrase('blood_group'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="blood_group" value="<?php echo get_phrase($user_data['blood_group']); ?>" name="blood_group" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label class="col-md-3 col-form-label" for="allergies"><?php echo get_phrase('allergies'); ?>:</label>
                                                <div class="col-md-9">
                                                    <input type="text" id="allergies" maxlength="10" value="<?php echo get_phrase($user_data['allergies']); ?>" name="allergies" class="form-control">
                                                </div>
                                            </div>
                                        <!-- </div> -->
                                        <div class="form-group row mb-3">
