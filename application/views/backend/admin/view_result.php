        			     ...
        			     <div class="text-center header">
                            <div style="float: left;">
        			         ...
        			         <div class="text-right">
                                <a class="edit-pen" href="<?php echo site_url('admin/result/edit/'.$log['id']).'/'.$user['id']; ?>"><i class="fas fa-pencil-alt"></i></a>
                                &nbsp;&nbsp;&nbsp;<a href="#" onclick="confirm_modal('<?php echo site_url('admin/result/delete/'.$log['id'].'/'.$log['sid']); ?>');" class="text-danger delete-can"><i class="far fa-trash-alt"></i></a>
                            </div>
