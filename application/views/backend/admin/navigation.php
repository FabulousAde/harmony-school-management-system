		...
		<ul class="metismenu side-nav side-nav-light">
			...
			<li class="side-nav-item <?php if ($page_name == 'categories' || $page_name == 'category_add' || $page_name == 'category_edit' ): ?> active <?php endif; ?>">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'categories' || $page_name == 'category_add' || $page_name == 'category_edit' ): ?> active <?php endif; ?>">
					...
					<span> <?php echo get_phrase('faculties'); ?> </span>
					<span class="menu-arrow"></span>
				</a>
				<ul class="side-nav-second-level" aria-expanded="false">
					<li class = "<?php if($page_name == 'categories' || $page_name == 'category_edit') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/categories'); ?>"><?php echo get_phrase('faculties'); ?></a>
					</li>

					<li class = "<?php if($page_name == 'category_add') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/category_form/add_category'); ?>"><?php echo get_phrase('add_new_faculty'); ?></a>
					</li>
				</ul>
			</li>

			<li class="side-nav-item">
				<a href="<?php echo site_url('admin/courses'); ?>" class="side-nav-link <?php if ($page_name == 'courses' || $page_name == 'course_add' || $page_name == 'course_edit' || $page_name == 'mark_evaluation' || $page_name == 'add_resources' || $page_name == 'archived_courses' || $page_name == 'print_evaluation')echo 'active';?>">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('admin/cbt'); ?>" class="side-nav-link <?php if ($page_name == 'new_cbt' || $page_name == 'cbt_edit')echo 'active';?>">
					<i class="dripicons-archive"></i>
					<span><?php echo get_phrase('ctb_exams'); ?></span>
				</a>
			</li>
			...
			?>
				...
				<li class="side-nav-item">
					<a href="<?php echo site_url('admin/lesson_note'); ?>" class="side-nav-link <?php if ($page_name == 'lessonnotes' || $page_name == 'new_lessonnote')echo 'active';?>">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('admin/users'); ?>" class="side-nav-link <?php if ($page_name == 'users' || $page_name == 'user_add' || $page_name == 'promotion_page' || $page_name == 'user_edit')echo 'active';?>">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('admin/instructors'); ?>" class="side-nav-link <?php if ($page_name == 'instructors_page' || $page_name == 'add_new_instructor')echo 'active';?>">
			...
			<li class="side-nav-item">
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<!--      DUPLICATION OF ADMIN  REVENUE                             -->
					 <li class = "<?php if($page_name == 'admin_expenses') echo 'active'; ?>" > <a href="<?php echo site_url('admin/admin_expenses'); ?>"><?php echo get_phrase('admin_expenses'); ?></a> </li>
					 <!--  END DUPLICATION OF ADMIN  REVENUE                             --> 
			...
			?>
				...
				<li class="side-nav-item">
					<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'new_result' || $page_name == 'view_result' || $page_name == 'results_filter') echo 'active';?>">
						<i class="fas fa-poll"></i>
						<span><?php echo get_phrase('result'); ?></span>
						<span class="menu-arrow"></span>
					</a>
					<ul class="side-nav-second-level" aria-expanded="false">
					    <li class = "<?php if($page_name == 'admin_revenue') echo 'active'; ?>" > <a href="<?php echo site_url('admin/result'); ?>"><?php echo get_phrase('Students'); ?></a></li>
						<li class = "<?php if($page_name == 'results_filter') echo 'active'; ?>">
							<a href="<?php echo site_url('admin/filtered_result'); ?>"><?php echo get_phrase('filtered_result'); ?></a>
						</li>
					</ul>
				</li>
			...
			<li class="side-nav-item">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'message' || $page_name == 'newsletter'): ?> active <?php endif; ?>">
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					<li class = "<?php if($page_name == 'message') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/message'); ?>"><?php echo get_phrase('private_message'); ?></a>
					</li>
					<li class = "<?php if($page_name == 'newsletter') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/newsletter'); ?>"><?php echo get_phrase('newsletter'); ?></a>
					</li>
				</ul>
			</li>
			
			<li class="side-nav-item">
				<a href="<?php echo site_url('admin/activities'); ?>" class="side-nav-link <?php if ($page_name == 'actvities' || $page_name == 'new_activity' || $page_name == 'edit_activity' || $page_name == 'activities_resources') echo 'active';?>">
					<i class="fas fa-chart-line"></i>
					<span><?php echo get_phrase('activities'); ?></span>
				</a>
			</li>
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('login/logout/user'); ?>" class="side-nav-link">
