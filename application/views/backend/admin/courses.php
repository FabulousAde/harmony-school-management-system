        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('courses'); ?>
                    <a href="<?php echo site_url('admin/archieve_all_courses/all'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"  style="margin-right: 10px;"><i class="mdi mdi-plus"></i><?php echo get_phrase('archive_all_courses'); ?></a> 
                    <a href="<?php echo site_url('admin/add_resources'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"style="margin-right: 10px;" ><i class="mdi mdi-plus"></i><?php echo get_phrase('add_course_resources'); ?></a>
                    <a href="<?php echo site_url('admin/course_form/add_course'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"  style="margin-right: 10px;"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_course'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                        ...
                        <a href="<?php echo site_url('admin/courses'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('all_courses'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/archived'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <i class="fas fa-archive text-muted" style="font-size: 24px; margin-top: 10px;"></i>
                                    <h3><span><?php echo $this->crud_model->get_archieved_courses()->num_rows(); ?></span></h3>
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('archived_courses'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <form class="row justify-content-center" action="<?php echo site_url('admin/courses'); ?>" method="get">
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            <label for="category_id"><?php echo get_phrase('faculty'); ?></label>
                    ...
                    <table id="course-datatable" class="table table-striped dt-responsive nowrap" width="100%" data-page-length='25'>
                        <thead>
                            <tr>
                                ...
                                <th><?php echo get_phrase('faculty'); ?></th>
                        ...
                        <tbody>
                            <?php foreach ($courses as $key => $course):
                                ...
                                $parent_categoryname = $this->crud_model->get_category_details_by_id($category_details['parent'])->row_array();
                                ...
                                $course_evaluation_status = $this->crud_model->get_written_eveluation('status', $course['id']);
                            ?>
                                <tr>
                                    <td><?php echo ++$key; ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge badge-dark-lighten"><?php echo  $parent_categoryname['name']."<br>".$category_details['name']; ?></span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                              ...
                                              <li>
                                                  <a class="dropdown-item" href="<?php echo site_url('admin/enrol_course_for_students/'.$course['id']); ?>"><?php echo get_phrase('enrol_for_students'); ?></a>
                                              </li>
                                              ...
                                              <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/course_actions/archive/'.$course['id']); ?>');"><?php echo get_phrase('archive_course'); ?></a></li>
                                              <?php if($course_evaluation_status == true): ?>
                                              <li><a class="dropdown-item" href="<?php echo site_url('admin/course_form/course_evaluations/'.$course['id']); ?>"><?php echo get_phrase('mark_evaluations'); ?></a></li>
                                              <?php endif; ?>
                                          </ul>
                                      </div>
                                    </td>
