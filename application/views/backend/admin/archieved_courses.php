        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="<?php echo site_url('admin/archieved'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('archieved_courses'); ?></p>
                                </div>
                            </div>
                        </a>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                              ...
                                              <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/course_actions/unarchieve/'.$course['id']); ?>');"><?php echo get_phrase('unarchieve_course'); ?></a></li>
                                          </ul>
                                      </div>
                                    </td>
                                </tr>
