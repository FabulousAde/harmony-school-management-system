                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="sub_faculty_id"><?php echo get_phrase('faculty'); ?><span class="required">*</span></label>
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="sub_faculty_id" id="sub_faculty_id" required>
                                                            <option value=""><?php echo get_phrase('select_a_faculty'); ?></option>
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="level" id="level">
                                                        <option value="executive_training_course"><?php echo get_phrase('executive_training_course'); ?></option>
                                                        <option value="regular_training"><?php echo get_phrase('regular_training'); ?></option>
                                                        <option value="professional_courses"><?php echo get_phrase('professional_courses'); ?></option>
                                                        <option value="professional_diplomas"><?php echo get_phrase('professional_diplomas'); ?></option>
                                                        <option value="vocational_courses"><?php echo get_phrase('vocational_courses'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
