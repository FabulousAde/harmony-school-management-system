    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href = "<?php echo site_url('user/lesson_note/new'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_note'); ?></a>
            </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                              ...
                              <td>
                                <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo site_url('user/lesson_note/view/'.$notes['id']); ?>"><?php echo get_phrase('open_note'); ?></a></li>
                                        ...
                                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('user/lesson_note/delete/'.$notes['id']); ?>');"><?php echo get_phrase('delete_note'); ?></a></li>
                                    </ul>
                                </div>
                              </td>
                          </tr>
