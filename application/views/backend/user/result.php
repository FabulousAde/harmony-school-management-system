                            ...
                            <td>
                                  <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="<?php echo site_url('user/result/new/'.$user['id']) ?>"><?php echo get_phrase('new_result'); ?></a></li>
                                        <li><a class="dropdown-item" href="<?php echo site_url('user/result/view/'.$user['id']) ?>"><?php echo get_phrase('view_all_results'); ?></a></li>
                                    </ul>
                                </div>
                              </td>
                        </tr>
