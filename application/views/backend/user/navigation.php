...
<div class="left-side-menu left-side-menu-detached">
	...
	<!--- Sidemenu -->
		<ul class="metismenu side-nav side-nav-light">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/cbt'); ?>" class="side-nav-link <?php if ($page_name == 'new_cbt' || $page_name == 'cbt_edit') echo 'active';?>">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/lesson_note'); ?>" class="side-nav-link <?php if ($page_name == 'lessonnotes' || $page_name == 'new_lessonnote')echo 'active';?>">
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/evaluation'); ?>" class="side-nav-link <?php if ($page_name == 'evaluation' || $page_name == 'mark_evaluation')echo 'active';?>">
					<i class="dripicons-media-shuffle"></i>
			...
			<li class="side-nav-item">
				<a href="<?php echo site_url('user/result'); ?>" class="side-nav-link <?php if ($page_name == 'results' || $page_name == 'new_result' || $page_name == 'view_result' || $page_name == 'edit_result') echo 'active';?>">
