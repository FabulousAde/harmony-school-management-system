        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3"><?php echo get_phrase('exam_manager'); ?>
                    <!-- <a href="<?php // echo site_url('user/preview/'.$exam_id); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm ml-1" target="_blank"><?php // echo get_phrase('view_on_frontend'); ?> <i class="mdi mdi-arrow-right"></i> </a> -->
                    <a href="<?php echo site_url('user/cbt'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_cbt_exam_list'); ?></a>
                </h4>

                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('user/exam_edit/'.$exam_id); ?>" method="post" enctype="multipart/form-data">
                            <div id="basicwizard">
