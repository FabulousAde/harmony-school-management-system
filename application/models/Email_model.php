...
class Email_model extends CI_Model {
	...
	function password_reset_email($new_password = '' , $email = '') {
		...
		if($query->num_rows() > 0)
		{
			...
			$email_msg	=	"Your password has been sucessfully changed.";
	...
	public function send_newsLetter($msg = '', $emails = array(), $subject = '') {
		foreach ($emails as $key => $email) {
			$this->send_smtp_mail($msg, $subject, $email);
			// $this->send_smtp_mail('This is our yearly newsletter', 'Yearly newsletter', 'josnagato@gmail.com');
		}
	}
